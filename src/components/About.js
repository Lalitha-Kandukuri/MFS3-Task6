                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <hr></hr>
                            <p className='slide-in-bottom'>Ambitious full-stack developer, a self-led learner and team player <br></br>with one year of experience in web developement.
                            </p>
                            ...
                            <p className='slide-in-bottom'>
                                ...
                                The technology I've worked on : <span className="text-red ls-2">Java, R,<br></br>
                                Python, Sql, Html, Css, Js, Bootstrap </span>
                            </p>
                            <p className='slide-in-bottom'>
